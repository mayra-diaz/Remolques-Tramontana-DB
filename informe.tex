...
\begin{itemize}
    ...
    \item El trabajo total de los empleados del área de fabricación por fechas.
    \item Total de compras por carrocería.
    \item Stock de la empresa.
\end{itemize}
...
\begin{table}[H]
  ...
  \multicolumn{1}{|c|}{Empleado}          & 4+80+4+60+150+8+8+25+25+8                 & 372                        & 15                & \textbf{5580}           \\ \hline
  \multicolumn{1}{|c|}{Dirige}            & 4+8+1                                     & 13                         & 0                 & \textbf{0}              \\ \hline
  \multicolumn{1}{|c|}{Compra}            & 4+100+8+8+2+8                             & 130                        & 0                 & \textbf{0}              \\ \hline
  ...
  \multicolumn{1}{|c|}{Carroceria}        & 4+20+8+2+25+8+8+8+2+2+15+8+8+8+4+20+1+8+8 & 167                        & 40                & \textbf{6680}           \\ \hline
  \multicolumn{1}{|c|}{Asociado}          & 4+4+100                                   & 108                        & 0                 & \textbf{0}              \\ \hline
  \multicolumn{1}{|c|}{Bien}              & 100+1+15+2+20                             & 138                        & 250               & \textbf{34500}          \\ \hline
  \multicolumn{1}{l}{}                    & \multicolumn{1}{l|}{}                     & \multicolumn{2}{c|}{\textbf{Total}}            & 158390                  \\ \cline{3-5} 
  \end{tabular}
  \end{table}
Se estima un tamaño inicial de 158.390 KB (kilobytes).
...
\begin{table}[]
  ...
  \multicolumn{1}{|c|}{Empleado}          & 4+80+4+60+150+8+8+25+25+8                 & 372                        & 1                 & \textbf{372}            \\ \hline
  \multicolumn{1}{|c|}{Dirige}            & 4+8+1                                     & 13                         & 2550              & \textbf{33150}          \\ \hline
  \multicolumn{1}{|c|}{Compra}            & 4+100+8+8+2+8                             & 130                        & 240               & \textbf{31200}          \\ \hline
  ...
  \multicolumn{1}{|c|}{Carroceria}        & 4+20+8+2+25+8+8+8+2+2+15+8+8+8+4+20+1+8+8 & 167                        & 12                & \textbf{2004}           \\ \hline
  \multicolumn{1}{|c|}{Asociado}          & 4+4+100                                   & 108                        & 30                & \textbf{3240}           \\ \hline
  \multicolumn{1}{|c|}{Bien}              & 100+1+15+2+20                             & 138                        & 6                 & \textbf{828}            \\ \hline
  \multicolumn{1}{l}{}                    & \multicolumn{1}{l|}{}                     & \multicolumn{2}{c|}{\textbf{Total}}            & 734270                  \\ \cline{3-5} 
  \end{tabular}
  \end{table}
Se estima un crecimiento semestral de 734.270 KB (kilobytes).
...
\begin{itemize}
    ...
    \textcolor{Blue}{\underline{dni:int}, nombre:string,  celular:int, correo:string,  direccion:string,  nacimiento:datetime, nCuenta:int, area:string, cargo:string, sueldo:float})
    ...
    \textcolor{Blue}{\underline{nFactura:int}, \underline{\textcolor{ForestGreen}{Bien}.descripcion:string}, fecha:datetime, precioUnitario:float, cantidad:int, \textcolor{ForestGreen}{Proveedor}.RUC})
...
\begin{table}[H]
  ...
  nacimiento     & datetime              &                                  &                                  & Fecha de nacimiento del empleado       \\ \hline
...
\subsection{Compra}
  ...
  fecha            & datetime              &                       & \multicolumn{1}{l|}{} & Fecha de la compra                                \\ \hline
...
\begin{table}[H]
  ...
  fecha          & datetime              &                                  &                                  & Fecha de inicio de producción de la carrocería \\ \hline
  \end{tabular}
\end{table}
